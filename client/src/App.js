...
const RulesPage = ({ onBack }) => (
  <div style={{ padding: '50px 15%', backgroundColor: '#fff', minHeight: '100vh', lineHeight: '1.8', color: '#333' }}>
    ...
    <h1 style={{ borderBottom: '2px solid #b8860b', paddingBottom: '10px', fontSize: '1.8rem' }}>INSIGHT Ұлттық ақпараттық порталының қызметтерін пайдалану ережелері</h1>
    <p><b>Осы ережемен танысу міндетті. Порталдың қызметтерін пайдалану немесе материал жариялау арқылы Сіз осы келісімшарт талаптарымен толықтай келіскен болып есептелесіз. Ережені оқымау жауапкершіліктен босатпайды.</b></p>
    <p><b>1. Жалпы ережелер</b></p>
    <p>1.1. Осы құжат «INSIGHT» Ұлттық ақпараттық порталында (бұдан әрі – «Портал») материалдар жариялау, ақпаратты тұтыну және қызметтерге тапсырыс беру шарттарын белгілейді.</p>
    <p>1.2. Порталдың мақсаты – қоғамға шынайы, сапалы ақпарат тарату, білім беру және ұлттық құндылықтарды насихаттау.</p>
    <p>1.3. Портал әкімшілігі осы келісімшарт талаптарын кез келген уақытта біржақты тәртіпте өзгертуге құқылы.</p>
    <p><b>2. Материалдарды жариялау талаптары</b></p>
    <p>2.1. Порталға материал жіберуші (Автор) келесі талаптарды сақтауға міндетті. Төмендегі мазмұндағы контенттерді жариялауға қатаң тыйым салынады:</p>
    <p>Қазақстан Республикасының заңнамасына қайшы келетін, конституциялық құрылымды бұзуға шақыратын материалдар;</p>
    <p>Этикаға жат, ұятсыз, біреудің ар-намысы мен қадір-қасиетіне нұқсан келтіретін ақпараттар;</p>
    <p>Діни араздықты немесе саяси экстремизмді насихаттайтын мақалалар;</p>
    <p>Дәлелсіз, жалған және тексерілмеген ақпараттар;</p>
    <p>Әкімшіліктің рұқсатынсыз орналастырылған коммерциялық жарнамалар мен бөгде сайттарға белсенді сілтемелер.</p>
    <p>2.2. Жарияланған материалдың авторлық құқығына және мазмұнының дұрыстығына автор тікелей және толықтай жауапты.</p>
    <p>2.3. Портал материалдардағы техникалық, грамматикалық немесе стильдік қателер үшін жауапкершілік көтермейді.</p>
    <p><b>3. Авторлық құқық және материалдарды пайдалану</b></p>
    <p>3.1. «INSIGHT» порталында жарияланған авторлық материалдар мен мақалаларды көшіріп басу немесе үзінді алу кезінде порталға тікелей гиперсілтеме (hyperlink) көрсету міндетті.</p>
    <p>3.2. Автор материалды порталға жіберу арқылы оны өңдеуге және порталдың әлеуметтік желілерінде таратуға келісім береді.</p>
    <p><b>4. Құпиялылық саясаты</b></p>
    <p>4.1. Пайдаланушы тіркелу кезінде берген жеке деректерінің (аты-жөні, email, байланыс нөмірі) сақталуына және өңделуіне келісім береді.</p>
    <p>4.2. «INSIGHT» порталы пайдаланушы деректерін үшінші тарапқа жария етпеуге міндеттенеді (ҚР заңнамасында көзделген жағдайларды қоспағанда).</p>
    <p><b>5. Қорытынды ережелер</b></p>
    <p>5.1. Осы келісім бойынша туындаған барлық даулар Қазақстан Республикасының қолданыстағы заңнамасы аясында шешіледі.</p>
    <p>5.2. Портал жұмысына қатысты сұрақтар немесе ұсыныстар бойынша әкімшілікке ресми байланыс арналары арқылы хабарласуға болады.</p>
  </div>
);
...
const formCardStyle = { backgroundColor: '#fff', padding: '30px', border: '1px solid #eee', position: 'sticky', top: '150px', display: 'flex', flexDirection: 'column' };
...
const modalContentStyle = { background: 'white', padding: '40px', width: '350px', maxHeight: '90vh', overflowY: 'auto' };
const closeBtnStyle = { width: '100%', border: 'none', background: 'none', marginTop: '15px', color: '#999', cursor: 'pointer' };
const loginPromptStyle = { padding: '30px', textAlign: 'center', backgroundColor: '#fff' };
